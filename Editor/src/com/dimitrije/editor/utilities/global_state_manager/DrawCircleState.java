...
import com.dimitrije.editor.models.diagram_model.EditorDiagramModelCircle;
...
public class DrawCircleState extends State {
    ...
    public void mouseReleased(MouseEvent e, EditorDiagramModel editorDiagramModel, EditorDiagramDrawPane editorDiagramDrawPane) {
        if (editorDiagramModel.isSelecting() && editorDiagramModel.selectionHasArea()) {
            createNewCircle(editorDiagramModel);
        }
    ...
    private void createNewCircle(EditorDiagramModel editorDiagramModel) {
        Rectangle rectangle = editorDiagramModel.getSelectionBox();

        EditorDiagramModelElement element = new EditorDiagramModelCircle("","", Color.blue, rectangle.x, rectangle.y, rectangle.width, rectangle.height);
